...
def processCursor(cur, dataframe=False):
    ...
    for row in cur:
        x_features.append([
            ...
            float(row[2]),
            float(row[3])])
        y_labels.append([float(row[4])])

    x_features_train = np.array(x_features)
    y_labels_train = np.array(y_labels)

    # for row in array:
    # x_features.append(x0)
    # x_features.append(x1)
    # x_features.append(x2)
    # y_labels.append(y)
    ...
    return x_features_train, y_labels_train
